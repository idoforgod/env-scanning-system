...
def init_command(
    ...
    if allowed_tools and argument_hint and model:
        ...
        content = COMMAND_TEMPLATE_WITH_TOOLS.format(
            allowed_tools=allowed_tools, description=description, command_title=command_title, body=body
        )
    else:
        content = COMMAND_TEMPLATE.format(description=description, command_title=command_title, body=body)
